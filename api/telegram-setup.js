...
module.exports = async function handler(req, res){
  try {
    ...
    await tg("setMyDescription", {description: "Alerts for yields on Robinhood Chain: get a message when a pool's APY crosses your level, or when a new pool appears. From tidewatch."}).catch(() => {});
